    ...
    >
      ...
      >
        <div className="flex justify-between items-center px-4 lg:px-0 relative text-white">
          <motion.div
            className={`bg-red-400/20 flex flex-col items-center justify-center w-12 h-12 p-3 order-2 lg:order-none cursor-pointer border-2 rounded-full  ${
              nav ? "gap-y-0" : "gap-y-1"
            }`}
            onClick={() => setNav(!nav)}
          >
          ...
          <motion.div
            ...
            initial="hidden"
            animate={nav ? "show" : ""}
            className="absolute bg-accent lg:w-[310px] w-[240px] h-[360px] lg:h-[400px] right-0 lg:left-0 top-[120px] bottom-0 z-50 rounded-lg shadow-xl"
          >
            <Nav />
          </motion.div>
        </div>
